...
export default function AuthModal({countryList, portList, portMapping}:Props) {
                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-md  transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    {isSignIn ?  <SignInForm signIn={true} setSignIn={setIsSignIn} /> : <SignUpForm setSignIn={setIsSignIn} countries={countryList} ports={portList} portMapping={portMapping}/>}
