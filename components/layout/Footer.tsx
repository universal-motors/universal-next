                ...
                <div className="container">
                        ...
                        <div className="col-md-3 col-12 f1 ">
                            ...
                            <div className='text-cyan-50'>
                                ...
                                <div className="flex-auto inline-flex mt-2" style={{ flexDirection: 'column' }}>
                                    ...
                                    <p>7103 Kaburagi Mansion, Nishi Nakanobu, 3-2-17, Shinagawa Ku, 142-0054
                                        <br /><b>Tokyo, Japan</b>
                                    </p>
                                </div>
                            </div>
                            ...
                            <ul className="mt-3" >
                                ...
                                <li>
                                    ...
                                    <a style={{ textDecoration: 'none' }} href="https://www.universalmotorsltd.com/" target="">
                                ...
                                <li>
                                    <h6>E-mail: </h6>
                                    <a style={{ textDecoration: 'none' }} href="mailto:csd@universalmotorsltd.com">
                    ...
                    <div className="copyright row">
                        <div className="col-md-3 col-sm-12">
                            <Image src="/assets/images/logo.png" alt="logo" className="header-logo" width={60}
                                   height={60} />
                        </div>
