          ...
          <div className='row'>
            ...
            <div className='col-xl-9 col-lg-9 col-md-8 col-sm-12 col-12'>
              ...
              <p>
                ...
                regulations relating to contributing to the maintenance of
                international peace and security, as well as anti-terrorism,
                including all applicable export controls, must be followed by
                Universal Motor. Any transaction against this is hereby
                prohibited.
              </p>
            </div>
          </div>
